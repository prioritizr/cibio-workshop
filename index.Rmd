...
## cache code chunks if running on travis to reduce build timings
if (identical(Sys.getenv("TRAVIS_BRANCH"), "master"))
  knitr::opts_chunk$set(cache = TRUE)
# show answers if desired
show_answers <- isTRUE(identical(Sys.getenv("MANUALVERSION"), "TEACHER"))
```
