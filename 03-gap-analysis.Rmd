...
6. Yes, the largest protected areas tend to have the great representation (broadly speaking). \newline
    See `plot(x = abundance_data$absolute_held, y = repr_data$relative_held)`
